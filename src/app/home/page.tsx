      ...
      {isLoading ? (
        ...
        <div className="mx-auto max-w-2xl p-4">
          ...
          <WeekHeader
            ...
            totalWeeks={10} // TODO: Get from study
            date={weekData.date}
            title={weekData.title}
            studyTitle={weekData.study.title}
...
function WeekHeader({
  ...
  return (
    <div className="text-center">
      {/* Study Title */}
      <p className="text-sm font-medium text-amber-600 dark:text-amber-400 mb-1">{studyTitle}</p>

      {/* Week Navigation */}
      <div className="flex items-center justify-center gap-4">
        {/* Previous Week Button (placeholder - would need prev/next week logic) */}
        <button
          className="flex h-10 w-10 items-center justify-center rounded-full text-stone-400 hover:bg-stone-100 dark:hover:bg-stone-800 transition-colors disabled:opacity-30"
        ...
        <div>
          ...
          <p className="text-sm text-stone-500 dark:text-stone-400">
            {formatDate(new Date(date), { weekday: 'long', month: 'long', day: 'numeric' })}
          </p>
          {title && (
            <p className="mt-1 text-stone-600 dark:text-stone-300 italic">&ldquo;{title}&rdquo;</p>
          )}
        </div>

        {/* Next Week Button (placeholder) */}
        <button
          className="flex h-10 w-10 items-center justify-center rounded-full text-stone-400 hover:bg-stone-100 dark:hover:bg-stone-800 transition-colors disabled:opacity-30"
    ...
    <Card>
      <CardContent className="p-6">
        <div className="space-y-3 text-center">
          ...
          <h2 className="text-xl font-bold text-stone-900 dark:text-white">No Study Active</h2>
